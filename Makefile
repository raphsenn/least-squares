...
compile: application.o linear.o slider.o squared.o exp.o main.o link
...
link:
	g++ -o main application.o linear.o slider.o squared.o exp.o main.o -lsfml-graphics -lsfml-window -lsfml-system
